                        ...
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td class="align-middle">
                                    ...
                                    <a href="{{ route('admin.EditCustomer',$customer->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                        <span class="badge badge-sm bg-gradient-success">Edit</span>
                                    </a>

                                    <a class="text-secondary font-weight-bold text-xs"  >
                                        <span data-bs-toggle="modal" data-original-title="test" data-bs-target="#deletemodal" id="deletebtn" data-id="{{ $customer->id }}" class="badge badge-sm bg-gradient-danger">Delet</span>
                                    </a>
                                </td>
